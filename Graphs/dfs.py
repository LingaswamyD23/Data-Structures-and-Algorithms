...
class Graph:
    ...
    def depthFirstTraversal(self, startNode, endNode, visited):

        if startNode.value == endNode.value:
            print("visiting node:", startNode.value)
            print('Found it..!')
            return
        print("visiting node:", startNode.value)
        visited.add(startNode)
        for adjacency in startNode.edgeList:
            if adjacency not in visited:
                self.depthFirstTraversal(adjacency, endNode, visited)
...
if __name__ == '__main__':
    ...
    graph.depthFirstTraversal(DFW, MIA, set())
